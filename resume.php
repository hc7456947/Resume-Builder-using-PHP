...
$educationDetails .= '</ul>'; 
    ...
    <div class="header" style="padding:5px 0px">
        <div class="header-content">
            <img src="' . $uploadDir . $fileName . '" height="175" width="140" style="float: left; border-radius: 100px; margin: 0px 0px 0px 40px">
        </div>
        <div >
            <h1 style="padding:20px 0px 0px 0px">'.$name.'</h1>
            <h3 style="padding:0px 0px 0px 10px">'.$design.'</h3>
        </div>

        <div style="margin-right: 40px;padding:10px 0px;">
    <div style="display: flex; align-items: center;padding:5px 0px 5px 0px;">
        <img src="phone.png" width="30" style="border-radius: 20px;">
        <span style="color: rgb(205, 155, 38;">' .$phone.'</span>
    </div>
    <div style="display: flex; align-items: center;padding:0px 0px 5px 0px;">
        <img src="email.png" width="30" style="border-radius: 20px;">
        <span style="color: rgb(205, 155, 38;">' .$email.'</span>
    </div>
    <div style="display: flex; align-items: center;padding:0px 0px 5px 0px;">
        <img src="linkedin.png" width="30" style="border-radius: 20px;">
        <span style="color: rgb(205, 155, 38;"> '.$linkedin.'</span>
    </div>
    <div style="display: flex; align-items: center;padding:0px 0px 5px 0px;">
        <img src="github.png" width="30" style="border-radius: 20px;">
        <span style="color: rgb(205, 155, 38;">'.$github.'</span>
    </div>
    <div style="display: flex; align-items: center;padding:0px 0px 5px 0px;">
        <img src="address.png" width="30" style="border-radius: 20px;">
        <span style="color: rgb(205, 155, 38;">'.$address.'</span>
    </div>
</div>
    ...
    <hr style="border:1px solid rgb(205, 155, 38);;">
    ...
    <hr style="border:1px solid rgb(205, 155, 38);;">           
        ...
        <hr style="border:1px solid rgb(205, 155, 38);margin:0px;">
